      ...
      <header className="border-b sticky top-0 z-30 bg-background/95 backdrop-blur">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-base font-bold">Admin: Placement Drive Questions</h1>
              <p className="text-xs text-muted-foreground">Submit & Manage Campus Drive Questions</p>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            <Link href="/placement-questions" target="_blank">
                    ...
                    {filteredQuestions.map((q) => (
                      <TableRow key={q.id}>
                        <TableCell className="font-semibold text-foreground">
                          {q.company}
                          {q.year && (
                            <span className="text-xs text-muted-foreground ml-1">({q.year})</span>
                          )}
                        </TableCell>
                        <TableCell>
